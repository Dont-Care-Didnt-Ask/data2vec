...
from torchvision.transforms import Compose, Lambda, RandomHorizontalFlip, RandomResizedCrop, ToTensor, ColorJitter
...
from data_processing.simple_mask_generator import MaskGenerator
...
class Data2VecImagenetIterableYTDataset(IterableYTDataset):
    def __init__(self,
        root: str, 
        image_size: int=224,
        ...
        super().__init__(root, num_readers=num_readers, chunk_distributed=chunk_distributed)
    ...
    def row_processor(self, row):
        ...
        return {"pixel_values": self.transform_image(img), "mask": self.mask_generator()}
